<?php
//000000000000s:13923:"<script src="/public/js/viewer/viewer.min.js"></script>
...
<div class="people-comment">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 p">
                <div class="dstar start5">
                   <i class="start start1" style="width:80%"></i>
                </div>
            </div>

            <!--评论内容-->
            <div class="lifr4 comfis p">
                <span class="faisf">买来送给我老公的, 嘻嘻....</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_289">
                                            <a><li><img data-original="/public/upload/goods/2016/04-21/57182dc652219.jpg" src="/public/upload/goods/2016/04-21/57182dc652219.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/04-21/57182dd9dee42.jpg" src="/public/upload/goods/2016/04-21/57182dd9dee42.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/04-21/57182dd9c365c.jpg" src="/public/upload/goods/2016/04-21/57182dd9c365c.jpg"/></li></a>
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_289'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
            ...
            <div class="lifr4 bolist p">
                <span>2016-04-21 20:59:59</span>
            <!--购买商品规格-->
                <!--<span></span>-->
            <!--评论者评论时间与购买时间差-->
                <!--<span>购买16913天后评价</span>-->
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="289"><i class="detai-ico z-ten"></i><span id="span_zan_289" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_289" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 p">
                <div class="dstar start5">
                   <i class="start start1" style="width:0%"></i>
                </div>
            </div>

            <!--评论内容-->
            <div class="lifr4 comfis p">
                <span class="faisf">买回去男朋友很喜欢 ..</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_255">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_255'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="255"><i class="detai-ico z-ten"></i><span id="span_zan_255" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_255" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <!--评论内容-->
            <div class="lifr4 comfis p">
                <span class="faisf">少女们都很喜欢.</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_221">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_221'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="221"><i class="detai-ico z-ten"></i><span id="span_zan_221" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_221" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
