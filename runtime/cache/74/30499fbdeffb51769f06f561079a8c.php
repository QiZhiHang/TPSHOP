<?php
//000000000000s:184832:"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>商品详情</title>
    ...
    <div class="search-box p">
        <div class="w1224">
            <div class="search-path fl">
                    ...
                    <i class="litt-xyb"></i>
                                    <a href="/index.php/Home/Goods/goodsList/id/12.html">手机配件</a>
                    <i class="litt-xyb"></i>
                                    <a href="/index.php/Home/Goods/goodsList/id/100.html">电池 电源 充电器</a>
                    <i class="litt-xyb"></i>
                                <div class="havedox">
                    <span>小派M-20000超薄充电宝适用MIUI蘋果6s手机通用毫安移动电源便携</span>
                </div>
            </div>
        </div>
    </div>
    <div class="details-bigimg p">
        <div class="w1224">
                ...
                <div class="product-gallery">
                    <div class="product-photo" id="photoBody">
                        ...
                        <div class="product-img jqzoom">
                            <img id="zoomimg" src="/public/upload/goods/thumb/117/goods_thumb_117_400_400.jpeg" jqimg="/public/upload/goods/thumb/117/goods_thumb_117_800_800.jpeg">
                        </div>
                        <!-- 商品大图介绍 end ]]-->
                        <!-- 商品小图介绍 start [[-->
                        <div class="product-small-img fn-clear"> <a href="javascript:;" class="next-left next-btn fl disabled"></a>
                            <div class="pic-hide-box fl">
                                <ul class="small-pic" style="left:0;">
                                        ...
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/117/goods_sub_thumb_446_60_60.jpeg" data-img="/public/upload/goods/thumb/117/goods_sub_thumb_446_400_400.jpeg" data-big="/public/upload/goods/thumb/117/goods_sub_thumb_446_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/117/goods_sub_thumb_447_60_60.jpeg" data-img="/public/upload/goods/thumb/117/goods_sub_thumb_447_400_400.jpeg" data-big="/public/upload/goods/thumb/117/goods_sub_thumb_447_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/117/goods_sub_thumb_448_60_60.jpeg" data-img="/public/upload/goods/thumb/117/goods_sub_thumb_448_400_400.jpeg" data-big="/public/upload/goods/thumb/117/goods_sub_thumb_448_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/117/goods_sub_thumb_449_60_60.jpeg" data-img="/public/upload/goods/thumb/117/goods_sub_thumb_449_400_400.jpeg" data-big="/public/upload/goods/thumb/117/goods_sub_thumb_449_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                            <li class="small-pic-li ">
                                        <a href="javascript:;">
                                            <img src="/public/upload/goods/thumb/117/goods_sub_thumb_450_60_60.jpeg" data-img="/public/upload/goods/thumb/117/goods_sub_thumb_450_400_400.jpeg" data-big="/public/upload/goods/thumb/117/goods_sub_thumb_450_800_800.jpeg">
                                            <i></i>
                                        </a>
                                        </li>
                                                                    </ul>
                    ...
                    <div class="share">
                        ...
                        <script>
                            var jiathis_config = {
                                url:"http://www.newtpshop.com/index.php?m=Home&c=Goods&a=goodsInfo&id=117",
                                pic:"http://www.newtpshop.com/public/upload/goods/thumb/117/goods_thumb_117_400_400.jpeg",
                            }
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <h1>小派M-20000超薄充电宝适用MIUI蘋果6s手机通用毫安移动电源便携</h1>
                <!--商品抢购 start-->
                                <!--商品抢购  end-->
                <div class="shop-price-cou">
                    <div class="shop-price-le">
                        <ul>
                            ...
                            <li>
                                <span class="bigpri_jj" id="goods_price"><em>￥</em>69.90                                <!--<a href=""><em class="sale">（降价通知）</em></a>-->
                                </span>
                            </li>
                        </ul>
                        <ul>
                            <li class="jaj"><span>市场价：</span></li>
                            <li class="though-line"><span><em>￥</em>169.90</span></li>
                        </ul>
                                            </div>
                ...
                <!-- 规格 start [[-->
                            ...
                            <ul>
                                ...
                                <li class="lawir colo">
                                                                            <input type="radio" style="display: none" rel="土豪金" name="goods_spec[颜色]" value="103"  checked="checked"/>
                                        <a   onclick="select_filter(this);"  class="red">土豪金</a>
                                                                            <input type="radio" style="display: none" rel="象牙白" name="goods_spec[颜色]" value="104"  />
                                        <a   onclick="select_filter(this);" >象牙白</a>
                                                                            <input type="radio" style="display: none" rel="宝石蓝" name="goods_spec[颜色]" value="105"  />
                                        <a   onclick="select_filter(this);" >宝石蓝</a>
                                                                    </li>
                            </ul>
                        </div>
                                    <script>
                ...
                <div class="standard p">
                    <input type="hidden" name="goods_id" value="117" />
                    <a class="paybybill" href="javascript:;" onclick="AjaxAddCart(117,1,1);">立即购买</a>
                    <a class="addcar" href="javascript:;" onclick="AjaxAddCart(117,1,0);"><i class="sk"></i>加入购物车</a>
                </div>
            </div>
            </form>
            <!--看了又看-s-->
                ...
                <div class="introduceshop">
                    ...
                    <div class="shop-describe shop-con-describe p">
                        <div class="deta-descri">
                            <p class="shopname_de"><span>商品名称：</span><span>小派M-20000超薄充电宝适用MIUI蘋果6s手机通用毫安移动电源便携</span></p>
                            <div class="ma-d-uli p">
                                <ul>
                                    <!--<li><span>品牌：</span><span></span></li>-->
                                    <li><span>货号：</span><span>TP0000117</span></li>
                                                                        <li><span>产品名称：</span><span>Xiaopad/小派 M20000</span></li>
                                                                        <li><span>品牌：</span><span>Xiaopad/小派</span></li>
                                                                        <li><span>电池容量：</span><span>8100mAh</span></li>
                                                                    </ul>
                            </div>
                    ...
                    <div class="shop-describe shop-con-describe p" style="display: none;">
                        <div class="deta-descri">
                            ...
                            <h2 class="shopname_de">属性</h2>
                                    ...
                                    <p class="gray_t">产品名称</p>
                                    <p>Xiaopad/小派 M20000</p>
                                </div>
                                                            <div class="twic_a_alon">
                                    <p class="gray_t">品牌</p>
                                    <p>Xiaopad/小派</p>
                            ...
                            <div class="deta-descri p">
                                <div class="cte-deta">
                                    <ul id="fy-comment-list">
                                        ...
                                        <li data-t="4">
                                            <a href="javascript:void(0);">差评（2）</a>
                                        </li>
                                        <li data-t="5">
...
<div style="display: none" id="look_see">
    ...
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/123.html"><img class="wiahides" src="/public/upload/goods/thumb/123/goods_thumb_123_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/123.html">Canon/佳能 EOS 750D单反套机（18-55mm）高清数码相机苏宁易购</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>3997.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/124.html"><img class="wiahides" src="/public/upload/goods/thumb/124/goods_thumb_124_206_206.png" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/124.html">Nikon/尼康D3300入门单反相机 升级版AF-P 18-55镜头套机 分期购</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>2399.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/125.html"><img class="wiahides" src="/public/upload/goods/thumb/125/goods_thumb_125_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/125.html">【0首付分期】蚂蚁摄影联保单反数码相机Canon/佳能 EOS 760D套机</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>5499.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/126.html"><img class="wiahides" src="/public/upload/goods/thumb/126/goods_thumb_126_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/126.html">Canon/佳能 EOS 700D套机（18-55mm)数码单反相机 苏宁易购</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>3499.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/127.html"><img class="wiahides" src="/public/upload/goods/thumb/127/goods_thumb_127_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/127.html">Canon/佳能 EOS 70D套机(18-135mm)数码相机单反套机 苏宁易购</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>6798.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            <a href="/index.php/Home/Goods/goodsInfo/id/129.html"><img class="wiahides" src="/public/upload/goods/thumb/129/goods_thumb_129_206_206.jpeg" style="display: inline;"></a>
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/129.html">【蚂蚁摄影】Canon/佳能 PowerShot SX410 IS 媲单反长焦数码相机</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>1098.00</span>
            </p>
        </div>
    </div>
    <div class="tjhot-shoplist type-bot">
        <div class="alone-shop">
            ...
            <p class="shop_name2">
                <a href="/index.php/Home/Goods/goodsInfo/id/130.html">Nikon/尼康 D7200套机(18-140mm) 尼康D7200 单反相机 正品</a>
            </p>
            <p class="price-tag">
                <span class="li_xfo">￥</span><span>6340.00</span>
            </p>
        </div>
    </div>
<!--看了又看-s-->
...
//        })
        ...
        {
            var goods_price = 69.90; // 商品起始价
            var store_count = 1000; // 商品起始库存
            var spec_goods_price = {"103":{"key":"103","price":"69.90","store_count":100},"104":{"key":"104","price":"69.90","store_count":100},"105":{"key":"105","price":"69.90","store_count":100}};  // 规格 对应 价格 库存表   //alert(spec_goods_price['28_100']['price']);
            // 优先显示抢购活动库存
                        // 如果有属性选择项
        ...
        function ajaxComment(commentType,page){
            $.ajax({
                type : "GET",
                url:"/index.php?m=Home&c=goods&a=ajaxComment&goods_id=117&commentType="+commentType+"&p="+page,//+tab,
                success: function(data){
