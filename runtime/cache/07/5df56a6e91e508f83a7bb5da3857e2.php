<?php
//000000000000s:13933:"<script src="/public/js/viewer/viewer.min.js"></script>
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 comfis p">
                <span class="faisf">晒单给大家看看.我刚买的.</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_169">
                                            <a><li><img data-original="/public/upload/goods/2016/01-16/5699f30f76a97.jpg" src="/public/upload/goods/2016/01-16/5699f30f76a97.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/01-16/5699f30f5286d.jpg" src="/public/upload/goods/2016/01-16/5699f30f5286d.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/01-16/5699f30f28676.jpg" src="/public/upload/goods/2016/01-16/5699f30f28676.jpg"/></li></a>
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_169'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
            ...
            <div class="lifr4 bolist p">
                <span>2016-03-12 09:37:06</span>
            <!--购买商品规格-->
                <!--<span></span>-->
            <!--评论者评论时间与购买时间差-->
                <!--<span>购买16872天后评价</span>-->
    ...
    <!--点赞，回复-->
        <div class="g_come">
            ...
            <a  onclick="zan(this);"  data-comment-id="169"><i class="detai-ico z-ten"></i><span id="span_zan_169" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_169" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <!--评论内容-->
            <div class="lifr4 comfis p">
                <span class="faisf">不错,买回来老公很喜欢</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_103">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_103'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="103"><i class="detai-ico z-ten"></i><span id="span_zan_103" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_103" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 p">
                <div class="dstar start5">
                   <i class="start start1" style="width:60%"></i>
                </div>
            </div>

            <!--评论内容-->
            <div class="lifr4 comfis p">
                <span class="faisf">这东西不错,下次还会来买</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_37">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_37'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="37"><i class="detai-ico z-ten"></i><span id="span_zan_37" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_37" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
